...
# ==============================================================================
# STRATEGY 2: THE "HOLY GRAIL" REGIME SWITCHING MODEL
# ==============================================================================
SYMBOL = "SOXL"
...
# THE INCOME ENGINE: Original 15-45 Day Monthlies
...
def run_holy_grail_strategy():
    print(f"Loading data for Strategy 2 (The Holy Grail Regime Switch)...")
    df = load_data()
    ...
    for current_date in all_dates:
        ...
        if not is_uptrend:
            ...
            # Pure Cash Fortress (5% Yield)
            cash += cash * RISK_FREE_RATE

        else:
            # --- BULL REGIME: BUY SOXL & WRITE CALLS ---
            if active_call:
                call_market = today_data[(today_data['Expiration'].dt.date == active_call['Expiration']) & 
                                         (today_data['strike'] == active_call['Strike']) & 
                                         (today_data['right'].str.startswith('C'))]
            ...
            if not active_call and shares > 0:
                ...
                if not valid_calls.empty:
                    if 'delta' in valid_calls.columns and valid_calls['delta'].notna().any() and not (valid_calls['delta'] == 0).all():
                        ...
                        # The perfectly balanced 15% OTM Fallback
    ...
    print("\n========================================")
    print("STRATEGY 2: THE HOLY GRAIL RESULTS")
    print("========================================")
