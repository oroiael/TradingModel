...
# Loaded globally so all CPU cores can read it without duplicating RAM
...
# --- THE MASSIVE PARAMETER GRID ---
# 5 x 5 x 5 x 5 x 5 x 4 = 12,500 Total Combinations
CALL_DTES = [7, 14, 21, 30, 45]                     
...
print(f"2. Full Factorial Initialized. Testing {total_runs} permutations across {cpu_cores} CPU Cores...\n")

# --- THE WORKER FUNCTION ---
def run_dynamic_backtest(params):
...
if __name__ == '__main__':
    ...
    # Fire up the parallel processing pool
    with concurrent.futures.ProcessPoolExecutor(max_workers=cpu_cores) as executor:
        # Map the grid to the worker function
        futures = {executor.submit(run_dynamic_backtest, params): params for params in grid}
    ...
    if results:
        ...
        output_name = "Massive_Collar_Optimization_Scoreboard.csv"
