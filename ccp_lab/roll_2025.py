#!/usr/bin/env python3
"""SOXL covered call + 90-day protective put, ROLLING the call — 2025 only.

Same rule as run_2025.py except the weekly call is never allowed to assign: on
...
cash the shares are still assigned, and that is reported.
    ...
    python3 ccp_lab/roll_2025.py

Writes ccp_lab/out/summary_2025_roll.md and the ledger/events/equity CSVs.
"""
import os, sys
