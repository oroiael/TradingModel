#!/usr/bin/env python3
"""SOXL covered call + 90-day protective put, ROLLING the call — 2024 only.

Same rule as run_2024.py except the weekly call is never allowed to assign: on
...
cash the shares are still assigned, and that is reported.
    ...
    python3 ccp_lab/roll_2024.py

Writes ccp_lab/out/summary_2024_roll.md and the ledger/events/equity CSVs.
"""
import os, sys
